...
import com.ethan0pia.bots.f2pLeveler.cowKiller.leaves.walkJack;
import com.ethan0pia.bots.f2pLeveler.cowKiller.leaves.tanHides;
...
public class atJack extends BranchTask {
	...
	public boolean validate() {
		...
		if(player !=null && jackArea.contains(player)) {
			return true;
		} else {
			return false;
		}
