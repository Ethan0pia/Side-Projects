package com.ethan0pia.bots.wellBot.ui;

import com.ethan0pia.bots.wellBot.WellBot;
...
public class PortableInfoUI extends GridPane implements Initializable{
    ...
    public PortableInfoUI(WellBot bot) {
        FXMLLoader loader = new FXMLLoader();
        Future<InputStream> stream = bot.getPlatform().invokeLater(() -> Resources.getAsStream("com/ethan0pia/bots/wellBot/ui/PortableUI.fxml"));
