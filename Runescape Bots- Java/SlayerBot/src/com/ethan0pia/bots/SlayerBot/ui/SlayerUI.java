...
public class SlayerUI extends GridPane implements Initializable {
    ...
    @FXML
    private ChoiceBox<Integer> cb1,cb2,cb4,cb5,cb6,cb7,cb8,cb9,cb10,cb11,cb12,cb13,cb18,cb22,cb39,cb57,cb62,cb76,cb111,cb112,cb38,cb75,cb63,cb47,cb33,cb64,cb70,cb44,cb17,cb79,cb34,cb20,cb19,cb14,cb15,cb65,cb48,cb50,cb36,cb28,cb43,cb23,cb40,cb41,cb24,cb55,cb53,cb16,cb74,cb25,cb58,cb99,cb45;
   ...
   private ChoiceBox[] gearSettup;
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        setVisible(true);
        slayerMaster.getItems().addAll("Turael", "Spria", "Vannaka","Chaeldar");
        ...
        gearSettup=new ChoiceBox[]{cb1,cb2,cb4,cb5,cb6,cb7,cb8,cb9,cb10,cb11,cb12,cb13,cb18,cb22,cb39,cb57,cb62,cb76,cb111,cb112,
                ...
                cb41,cb24,cb55,cb53,cb16,cb74,cb25,cb58,cb99,cb45};
            ...
            try {
                ...
                BufferedReader in = null;
                    try {
                        ...
                        if (read != null) {
                            read = read.trim();
                            spellType.getSelectionModel().select(read);
                        } else {
    ...
    private EventHandler<ActionEvent> getStart_BTAction() {
        return event -> {
            try {
                ...
                bot.setMaster(slayerMaster.getSelectionModel().getSelectedItem().trim());
 ...
 ******************************************************************************************************************************************************/
    ...
    public void update2() {
        try {
            uiSlayerMaster.textProperty().set(bot.getMaster());
