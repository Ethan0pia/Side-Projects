...
public class Root extends BranchTask {
    ...
    private HaveTask task = new HaveTask(Bot);
    ...
    public boolean validate() {
        ...
        Execution.delayUntil(() -> Bot.infoUI != null);
        ...
        Bot.infoUI.update1(tasksComplete, Bot.gpGained, gph, att,   attXP,   slay,   slayXP,   str,   strXP,   def,   defXP
                ,   mage,   mageXP,   range,   rangeXP,   hp,   hpXP,   pray,   prayXP, runTime, Bot.mobList.getTaskName(task),
